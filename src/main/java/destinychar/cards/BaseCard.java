package destinychar.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import destinychar.DestinyCharMod;
import destinychar.util.CardStats;
import destinychar.util.TriFunction;
...
import static destinychar.util.GeneralUtils.removePrefix;
import static destinychar.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return DestinyCharMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    DestinyCharMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
