...
import destinychar.util.GeneralUtils;
import destinychar.util.KeywordInfo;
import destinychar.util.Sounds;
import destinychar.util.TextureLoader;
...
@SpireInitializer
public class DestinyCharMod implements
        EditCardsSubscriber,
    ...
    public static void initialize() {
        ...
        Titan.Meta.registerColor();
    }

    public DestinyCharMod() {
    ...
    private static String checkResourcesPath() {
        String name = DestinyCharMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be at  \"resources/" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + DestinyCharMod.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(DestinyCharMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
