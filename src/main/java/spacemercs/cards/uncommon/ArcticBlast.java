...
public class ArcticBlast extends BaseCard {
    public static final String ID = makeID(ArcticBlast.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for(AbstractMonster t: AbstractDungeon.getCurrRoom().monsters.monsters) {
            addToBot(new ApplyPowerAction(t, p, new Slow(t, SLOW)));
        }
    }
}
